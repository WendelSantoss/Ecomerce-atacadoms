...
export default function ControlLoginProvider(props: any){
    ...
    async function login(email: string, senha: string){
        ...
        .catch((error) => {
            ...
            if(error.message === 'Firebase: Error (auth/invalid-email).'){
                ...
                setErro('O acesso desta conta está temporariamente bloqueado, por várias tentativas erradas. Resgate sua senha clicando em "Esqueceu sua senha" ou aguarde alguns momentos')
            }
    ...
    useEffect(()=>{
        ...
        return ()=> inscrito()
    },[user])/*função para manter o user logado em qualquer refresh da aplicação e 
    para setar o usuário nas funçoes de cadastro, login com google e login normal.*/

    return (
        
        <UserLoginLogout.Provider value={{
            user, loginGoogle, logout, login, cadastrar, erro, setandoErro
        }}>
